...
scatter_with_divs <- mcmc_scatter(
  ...
  alpha = 0.3,
  np = nuts_params(fitted_model_NB_hier),
  np_style = scatter_style_np(div_size = 1.5)
)
...
(see description at https://mc-stan.org/bayesplot/reference/MCMC-parcoord.html#plot-descriptions).
...
non-zero numbers, so we will leave in the hierarchy over $\texttt{kappa}$. Plotting the marginal
