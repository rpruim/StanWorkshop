...
* [Pest_Control_Example.Rmd](https://raw.githubusercontent.com/rpruim/StanWorkshop/master/docs/course-materials/Pest_Control_Example.Rmd) [right click to download]

HTML:       

* [Pest_Control_Example.html](https://raw.githubusercontent.com/rpruim/StanWorkshop/master/docs/course-materials/Pest_Control_Example.html) [right click to download]
...
* [simple_poisson_regression-starter.stan](course-materials/stan_programs/simple_poisson_regression-starter.stan)
* [simple_poisson_regression-solution.stan](course-materials/stan_programs/simple_poisson_regression-solution.stan)
...
* [multiple_poisson_regression.stan](course-materials/stan_programs/multiple_poisson_regression.stan)
* [multiple_NB_regression.stan](course-materials/stan_programs/multiple_NB_regression.stan)

#### Tuesday afternoon

* [hier_NB_regression.stan](course-materials/stan_programs/hier_NB_regression.stan)
* [hier_NB_regression_ncp.stan](course-materials/stan_programs/hier_NB_regression_ncp.stan)

#### Wednesday morning

* [hier_NB_regression_ncp_slopes_mod.stan](course-materials/stan_programs/hier_NB_regression_ncp_slopes_mod.stan)
* [hier_NB_regression_ncp_slopes_mod_mos.stan](course-materials/stan_programs/hier_NB_regression_ncp_slopes_mod_mos.stan)

#### Wednesday afternoon

* [hier_NB_regression_ncp_slopes_mod_mos_predict.stan](course-materials/stan_programs/hier_NB_regression_ncp_slopes_mod_mos_predict.stan)
* [hier_NB_regression_ncp_slopes_mod_mos_gp.stan](course-materials/stan_programs/hier_NB_regression_ncp_slopes_mod_mos_gp.stan) (for the Gaussian process section at end of Rmd file)
...
* [MCMC interactive gallery (movies!)](https://chi-feng.github.io/mcmc-demo/)
...
* *Statistical Rethinking* by McElreath
    * [book website](https://xcelab.net/rm/statistical-rethinking/)
        (2nd edition in the works)
    * [companion notes by R Pruim](https://rpruim.github.io/Statistical-Rethinking/)
        * [fork of rethinking package](https://github.com/rpruim/rethinking) -- but note that there is work being done on the official rethinking package, so this may not be so useful anymore.
    * [companion notes by using brms](https://bookdown.org/ajkurz/Statistical_Rethinking_recoded/)

* *Doing Bayesian Data Analysis* by Kruschke
    * [book website](https://sites.google.com/site/doingbayesiandataanalysis/)
    * [companion notes by R Pruim](https://rpruim.github.io/Kruschke-Notes/)
        * [style guide](https://rpruim.github.io/Kruschke-Notes/some-useful-bits-of-r.html#style-guide)
